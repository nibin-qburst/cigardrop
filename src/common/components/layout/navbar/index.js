    ...
    return (
      <nav className="navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div className="navbar-menu-wrapper d-flex align-items-center">
          <button
            className="navbar-toggler navbar-toggler d-none d-lg-block navbar-dark align-self-center mr-3"
            type="button"
          ...
          <button
            className="navbar-toggler navbar-dark navbar-toggler-right d-lg-none align-self-center"
            type="button"
